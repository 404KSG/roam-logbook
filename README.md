...
Current package version: **0.9.0-beta.32**. This is a beta fork; the graph remains
...
- The Roam Depot entry for this fork remains a **Draft preview**. Beta.32 keeps first-load switch defaults synchronized with Roam's Settings panel without overwriting existing choices; until acceptance, use its shorthand only for non-critical smoke tests.
