...
Current package version: **0.9.0-beta.40**. This is a beta fork; the graph remains
...
- The Roam Depot entry for this fork remains a **Draft preview**. Beta.40 adds the single-page Activity panel while preserving the Beta.39 Home action rail, compact Timing Line, and snapshot-only Dashboard reads; until acceptance, use its shorthand only for non-critical smoke tests.
