...
Current package version: **0.9.0-beta.51**. This is a beta fork; the graph remains
...
- The Roam Depot entry for this fork remains a **Draft preview**. Beta.51 introduces the Task Tracker identity, complete in-page context breadcrumbs, and single-surface Linear-style task interactions while preserving existing LOGBOOK/CLOCK data; until acceptance, use its shorthand only for non-critical smoke tests.
